...
<template>
	<div class="adminuser">
			...
			<thead>
				<tr class="adminuser-table-header">
					...
					<TableHeader
						...
						>ID</TableHeader
					>
					<TableHeader minWidth="150px">名稱</TableHeader>
					<TableHeader minWidth="150px">帳號</TableHeader>
					<TableHeader
						minWidth="100px"
					...
					<TableHeader
						...
						>啟用狀態</TableHeader
					>
					<TableHeader minWidth="200px">停用時間</TableHeader>
				</tr>
			</thead>
		...
		<AdminEditUser :searchParams="searchParams" />
	</div>
</template>
