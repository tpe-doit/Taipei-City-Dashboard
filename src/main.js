...
import EventDistrictChart from "./components/charts/EventDistrictChart.vue";
...
app.component("EventDistrictChart", EventDistrictChart);
app.component("RangeChart", RangeChart);
